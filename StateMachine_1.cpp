...
void StateMachine_1::init()
{
    ...
    local_var_.lvar_0=input_.in_3; local_var_.lvar_1=0;;
}
...
bool StateMachine_1::dispatch(const StateMachine_1Input* input, int size, int eventsIn)
{
    ...
    switch((StateType)state_.id_)
    {
        case Idle:
        {
            if ( true  && local_var_.lvar_1 > local_var_.lvar_0 )
            {
            ...
            else
            {
                ...
                local_var_.lvar_1++; output_.out_1 = 0;;
            }
        }break;
        case Requesting:
        {
            if ( true  && input_.in_1 == input_.in_0 && input_.in_2 > 0 )
            {
                /* Set current transition */
                transition_.id_ = 3;
            ...
            else if ( true  && input_.in_1 > 0 && input_.in_2 < 0 )
            {
                /* Set current transition */
                transition_.id_ = 5;
                /*Exit from Requesting*/
