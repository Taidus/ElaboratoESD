...
/* public methods */
    StateMachine();
    void init();
    bool dispatch(const StateMachineInput* input, int size, int eventsIn);
    const StateMachineInput* input() const;
    const StateMachineOutput* output() const;
    const StateMachineLocalVars* localVariables() const;
...
private:
/* Attributes */
    StateMachineInput input_;
    StateMachineOutput output_;
    StateMachineLocalVars local_var_;
    SMStateData state_;
